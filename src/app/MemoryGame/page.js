  ...
  return (
    <>
        ...
        <div className="text-center">
          ...
          <button
            className="font-mono border-2 border-white text-white p-2 w-28 mt-3 hover:bg-[#020000] hover:shadow-white hover:shadow hover:mt-2 hover:mb-1"
            onClick={shuffleCars}
          >
            New Game
          </button>
        ...
        <p className="text-white font-mono mt-3 font-semibold text-lg">
          Turns: {turns}
        </p>
